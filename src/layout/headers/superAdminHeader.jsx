  ...
  return (
    <>
      <header className="tp-header-2-area tp-header-height p-relative">
        ...
        >
          <div
            className="tp-header-2-bottom-inner tp-header-2-bottom-inner-one p-relative"
            style={{
              ...
              <div className="row gx-0 align-items-center">
                ...
                <div className="col-6 col-md-2">
                  <div className="tp-header-2-right d-none d-md-block">
                    <div className="tp-header-2-main-right d-flex align-items-center justify-content-xxl-end">
                      <div
                        className="tp-header-2-phone d-flex align-items-center admin-btn"
                      ...
                      {dropdownOpen && (
                        <div ref={dropdownRef} className="user-dropdown">
                          <Link onClick={handleLogut} className="link" href="">
                            <i className="fa-solid fa-sign-out-alt"></i> Sign
                            out
                          </Link>
                          <Link
                            ...
                            href=""
                          >
                            <i className="fa-solid fa-lock"></i> Forget Password
                          </Link>
                        </div>
                      )}
                    </div>
